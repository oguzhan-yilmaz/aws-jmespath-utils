...
expression = '[] | filter_tags(`["Name="]`, @)[].Tags' # it's important that your expression array must be inside `` backticks
...
expression = '[].filter_tags(`["*=1234"]`, @)[].Tags' # it's important that your expression array must be inside `` backticks
